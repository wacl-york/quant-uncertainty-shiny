...
params:
    company: "Arisense"
    device: !r c("Ari063", "Ari078", "Ari086", "Ari093")
    pollutant: "PM2.5"
    sensor: !r c("1", "2")
    cal_version: !r c("cal1")
    start: "2019-12-10"
    end: "2022-10-31"
---    
...
\item One device was in Manchester (`r deploy_f("Manchester",device_f("London"))`) -> London (`r deploy_f("London",device_f("London"))`)-> Manchester (2022-04-29).

\item One device was in Manchester (`r deploy_f("Manchester",device_f("York"))`) -> York (roadside side) (`r deploy_f("York",device_f("York"))`) -> Manchester (2022-04-29).
\end{itemize}
...
\begin{tcolorbox}[colback=white,
  ...
  arc=4pt]
\begin{math}
\text{RMSE}(R, \ L) = \sqrt{{mean}(R_i - \ L_i)^2}
\end{math}
